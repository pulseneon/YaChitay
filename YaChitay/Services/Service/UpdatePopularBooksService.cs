...
{
    public class UpdatePopularBooksService: BackgroundService
    {
        private readonly ILogger _logger;
        private readonly IServiceProvider _serviceProvider;
        private readonly PopularBooksCache _cache;
        private readonly IConfiguration _configuration;

        public UpdatePopularBooksService(IConfiguration configuration, IServiceProvider serviceProvider, PopularBooksCache cache,
            ILogger<UpdatePopularBooksService> logger)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                _logger.LogInformation("Have been updated in the background popular books: {0} ({1} of {2})", _cache.GetBooksNames(),
