...
{
    public class UpdateBooksOfDayService: BackgroundService
    {
        private readonly ILogger _logger;
        private readonly IServiceProvider _serviceProvider;
        private readonly BooksOfDayCache _cache;
        private readonly IConfiguration _configuration;

        public UpdateBooksOfDayService(IConfiguration configuration, IServiceProvider serviceProvider, BooksOfDayCache cache,
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                _logger.LogInformation("Have been updated in the background books of the day: {0} ({1} of {2})", _cache.GetBooksNames(),
